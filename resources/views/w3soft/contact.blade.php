...
{{--                        <h6 class="position-relative d-inline text-primary ps-4">Contact Us</h6>--}}
                        <h2 class="mt-2">
                            @if($lang=='uz') Har qanday so'rov uchun murojaat qiling @endif
                            @if($lang=='ru') Свяжитесь с нами по любым вопросам @endif
                            @if($lang=='en') For inquiries and appeals @endif
                        </h2>
                    </div>
