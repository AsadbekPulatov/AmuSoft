            ...
            <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('abouts.store')}}" method="POST" accept-charset="UTF-8"
                        ...
                        <div class="form-group">
                            <label for="lavozim">Профессия</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="text_uz"  id="description" rows="5">{{old('text_uz')}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="description">Текст(RU)</label>
                            <textarea class="form-control" name="text_ru"  id="description" rows="5">{{old('text_ru')}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="description">Текст(EN)</label>
                            <textarea class="form-control" name="text_en"  id="description" rows="5">{{old('text_en')}}</textarea>
                        </div>
                        <div class="form-group">
